...
/// </summary>
internal class SnapLayoutButton : IDisposable
{
    /// <summary>
    ...
    private void OnVisualLoaded(object sender, RoutedEventArgs e)
    {
        _visual.Loaded -= OnVisualLoaded;
        UpdateScale(_initialDpiScale);
    }
