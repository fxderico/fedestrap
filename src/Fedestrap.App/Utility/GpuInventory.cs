...
public static class GpuInventory
{
    ...
    private static void AddLinuxAdapters(List<GpuAdapterInfo> found)
    {
        try
        {
        ...
        {
            App.Logger?.WriteLine("GpuInventory", "sysfs enumeration failed: " + ex.Message);
        }
    }
