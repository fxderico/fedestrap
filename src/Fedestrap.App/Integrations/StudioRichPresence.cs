...
public sealed class StudioRichPresence : IDisposable
{
	...
	private static readonly HttpClient Http = Fedestrap.Utility.VpnHttpClient.Create(TimeSpan.FromSeconds(10));
	...
	{
		Fedestrap.Integrations.Studio.StudioState? state = Fedestrap.Integrations.Studio.StudioBridge.GetFreshState(TimeSpan.FromSeconds(12));
	...
	private void UpdatePresence()
	{
		...
		buttons.Add(new DiscordRPC.Button { Label = "Get Fedestrap", Url = App.WebsiteBaseUrl });
