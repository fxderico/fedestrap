...
namespace FedestrapClient.Common;
...
public static class PathHelper
{
	...
	public static string UserAppData => _userAppData ?? (_userAppData = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "FedestrapClientData"));
